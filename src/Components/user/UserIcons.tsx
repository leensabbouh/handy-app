    ...
    return (
        <Menu>
            ...
            <MenuList className="bg-black shadow-blue-500/20 border-blue-500 rounded z-20 py-2">
                <MenuItem
                    className="flex items-center px-2 pb-2 text-white hover:bg-gray-900 hover:border-none hover:outline-none">
                    <IoSettingsOutline/>
                    <span className="px-2">Profile</span></MenuItem>
                <MenuItem
                    className="flex items-center px-2 text-white  hover:bg-gray-900 hover:border-none hover:outline-none"
                    onClick={() => dispatch({type: 'UPDATE_USER', payload: null})}><CiLogout/> <span
                    className="px-2">LogOut</span></MenuItem>
            </MenuList>
        </Menu>
    )
}
